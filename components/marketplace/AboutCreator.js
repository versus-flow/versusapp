...
const AboutCreator = () => {
  return (
    <div className="bg-white py-12">
      <div class="container">
        <h3 class="font-black font-inktrap text-2xl">About the Creator</h3>
        <div class="gap-12 grid grid-cols-12 mt-4">
          <div class="bg-cream-500 col-span-4 flex flex-col items-center justify-center px-12 py-12 rounded">
            ...
            <h4 class="font-black font-inktrap text-2xl text-center">
              Alessandro Pautasso
            </h4>
            <p class="font-bold font-inktrap mb-2 text-center">@kaneda99</p>
            <Link href="#">
              <a class="standard-button transparent-button">Artist profile</a>
            </Link>
          </div>
