  ...
  return (
    <div className="py-12">
      <div className="container">
        ...
        <div className=" sm:grid-cols-2 lg:grid-cols-3 mt-6 gap-x-8 gap-y-4 lg:gap-x-16 lg:gap-y-8">
          <h1 className="text-3xl py-12 text-center transform -rotate-6 block w-full">
            Not yet open
          </h1>
          {/* {times(6, () => (
            <DropPreview />
