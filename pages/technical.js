        ...
        <div className="pt-12 pb-24 bg-white">
          <div className="container">
            ...
            <div className="mt-8 text-lg">
              ...
              <p className="mb-4">
                The nature of this type of decentralized application allows for
                censorship resistent onchain NFTs. Since the entirety of an NFT
                is stored on the Flow blockchain it will never change or lose
                its image. Versus NFTs are immutable and entirely under the
                control of their owner.
              </p>
              <p className="mb-4">
                This system also means that the only way to interact with the
                Versus application and contracts is through the spending of Flow
                tokens from a third party wallet provider. Versus is currently
                built to support Blocto, but in the future we should be able to
                support any other large wallet providers.
              </p>
              <p className="mb-4">
              ...
              <p className="mb-4">
                <br />A SODA has numerous advantages that will contribute to the
                longevity of the Versus platform.
              </p>
              <p className="mb-4">
                Versus should not face the scaling issues that some traditional
                blockchain dapps have faced. As long as wallet providers and the
                Flow blockchain are able to accommodate increasing demand Versus
                will effortlessly scale.
              </p>
              <p className="mb-4">
